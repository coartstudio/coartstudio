  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-10 md:py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-4xl mb-4 text-black max-w-4xl font-semibold">
          Our Proven Process
        </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_75%,transparent_85%)] "
        >
          <motion.div
            style={{
